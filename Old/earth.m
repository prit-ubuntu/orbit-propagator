...
alpha   = 0.97; % globe transparency level, 1 = opaque, through 0 = invisible
...
% Added to diplay orbital elements on Earth 
hold on
% plot orbit on top
plot3(s_real(:,1),s_real(:,2),s_real(:,3),'r')
hold on
plot3(s_theoretical(:,1),s_theoretical(:,2),s_theoretical(:,3),'w')
xlabel('ECI x [m]');
ylabel('ECI y [m]');
zlabel('ECI z [m]');